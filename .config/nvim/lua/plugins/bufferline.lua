...
-- 🔸 setup 前执行的初始化逻辑（可以为空）
M.init = function()
  -- 可以放高亮或前置设置
  -- vim.api.nvim_set_hl(0, "BufferLineIndicatorSelected", { fg = "#3498DB", bold = true })
end
...
M.keys = {
  ...
  { "<leader>bd", "<Cmd>BufferLinePickClose<CR>",                    desc = "Bufferline Pick Buffer Close" },
