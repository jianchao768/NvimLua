...
return {
  ...
  keys = {
    ...
    { "<leader>fg", function() require("fzf-lua").grep(vim.tbl_extend("force", { search = "" }, opts)) end, mode = "n", desc = "Grep selection" },
    { "<leader>fg", function() require("fzf-lua").grep_visual(vim.tbl_extend("force", { search = "" }, opts)) end, mode = "x", desc = "Grep visual selection" },
  ...
  config = function()
    ...
    fzf.setup({
      ...
      grep = {
        ...
        rg_opts = "--line-number --no-heading --color=always --smart-case --max-columns=4096 --column -e",
