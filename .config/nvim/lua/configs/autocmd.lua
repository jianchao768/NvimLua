...
--  group = vim.api.nvim_create_augroup("MyDiffHighlight", { clear = true }),
--  callback = function()
--    vim.cmd("highlight DiffAdd    guifg=#b8bb26 guibg=#282828")
--    vim.cmd("highlight DiffChange guifg=#8ec07c guibg=#282828")
--    vim.cmd("highlight DiffDelete guifg=#fb4934 guibg=#282828")
--    vim.cmd("highlight DiffText   guifg=#fabd2f guibg=#282828")
--  end,
--})
